...
public class ImageBarcodeExportTest {
    ...
    protected String template = "src/main/resources/imageBarcode.jasper";
    protected String outputXLS = "target/imageBarcodeXLS.xls";
    protected String outputPDF = "target/imageBarcodePDF.pdf";
    ...
    @Test
    public void barcodeXLSExportTest() throws Exception {
        ...
        JasperExportManager.exportReportToPdfFile(jasperPrint, "target/imageBarcodePDF.pdf");
    }
