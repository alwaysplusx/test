 ...
 */
public class TransactionAttributeSupportsTest {
    ...
    public void testSaveWithSupports() {
        userService.saveWithSupports(new User("wuxii-1"));
    }

    @Test
    public void testEchoWithSupports() {
        userService.echoWithSupports("wuxii-2");
    }

    @Test
    public void testSaveWithSupportsInClientTransaction() throws Exception {
        try {
            ux.begin();
            userService.saveWithSupports(new User("wuxii-2"));
            ux.commit();
        } catch (Exception e) {
            try {
                ux.rollback();
