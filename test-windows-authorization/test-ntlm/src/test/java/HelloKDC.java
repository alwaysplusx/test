...
public final class HelloKDC {
	...
	public static void main(final String[] args) throws Exception {
		...
		final String username = "zhenghz";

		// Password for the pre-auth acct.
		final String password = "zhang123789";

		// Name of our krb5 config file
		final String krbfile = "./src/test/resources/krb5.conf";

		// Name of our login config file
		final String loginfile = "./src/test/resources/login.conf";

		// Name of our login module
		final String module = "spnego-server";
	...
	private static void validate(final String username, final String password, final String krbfile,
			final String loginfile, final String moduleName) throws FileNotFoundException, NoSuchAlgorithmException {
